...
import kr.heartpattern.spikot.item.saveToTag
...
class ChatBuilder internal constructor() {
    ...
    fun hoverText(text: ChatBuilder) = execute {
        hoverEvent = HoverEvent(HoverEvent.Action.SHOW_TEXT, text.toBaseComponents())
    }
    ...
    fun toBaseComponents(): Array<BaseComponent> = components.toTypedArray()
}